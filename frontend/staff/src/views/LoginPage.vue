<template>
  <div class="container bg-light p-5">
    <Form class="form" @submit="onSubmit" :validation-schema="loginFormSchema">
      <legend class="form-title fw-bold">Nhân viên đăng nhập</legend>
      <div class="mb-3 form-group">
        ...
        <Field
          ...
          v-model="maNV"
        />
        <ErrorMessage name="maNV" class="error-feedback"></ErrorMessage>
      </div>
      <div class="mb-3 form-group">
...
const loginFormSchema = yup.object({
  maNV: yup.string().required('Mã nhân viên không được bỏ trống!'),
...
function showPassword() {
  if (passwordInputStatus.value === 'matKhau')
    passwordInputStatus.value = 'text';
  else passwordInputStatus.value = 'matKhau';
}
